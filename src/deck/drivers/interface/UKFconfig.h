...
#define MAX_UKF_BUFFER_LENGTH 10

#define MOTION_ESTIMATE_INTERVAL 20

#define N_STATE 3 // 状态量维度
#define N_MEAS 4 // 测量量维度

#define T 0.1 // 时间间隔
#define MAX_RUN_TIMES 100 // 运行次数

#define BASE_VELOCITY 50
...
*/
static double alpha = 0.5; //增大提高对新观测数据的敏感性，减小提高滤波稳定性
