...
#define ADHOC_DECK_AMEND_TX_TASK_NAME "ADHOC_AMEND_TX"
#define ADHOC_DECK_AMEND_RX_TASK_NAME "ADHOC_AMEND_RX"
...
#define UKF_TASK_STACKSIZE            (2 * configMINIMAL_STACK_SIZE)
